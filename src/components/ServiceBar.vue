<template>
    <div class="service">
      <div class="container">
          <ul>
              <li><span class="icon-setting"></span>预约参观服务</li>
              <li><span class="icon-7day"></span>预约参观服务</li>
              <li><span class="icon-15day"></span>预约参观服务</li>
              <li><span class="icon-post"></span>预约参观服务</li>
          </ul>
      </div>
    </div>
</template>>
